...
<%@ include file="../../header.jsp"%>
    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img class="img-responsive  img-rounded-circle" src="images/javalogo-2.jpg" alt="">
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img class="img-responsive img-rounded-circle" src="images/javascript_logo.png" alt="">
                </div>
                <div class="col-sm-6">
